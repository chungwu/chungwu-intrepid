...
export type WechatLogoIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function WechatLogoIcon(props: WechatLogoIconProps) {
  const { className, style, title, ...restProps } = props;
  return (
    <svg
      xmlns={"http://www.w3.org/2000/svg"}
      viewBox={"-51.45 -69.25 445.9 415.5"}
      height={"1em"}
      width={"1em"}
      style={{
        fill: "currentcolor",
