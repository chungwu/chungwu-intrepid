...
export type YcombinatorsvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function YcombinatorsvgIcon(props: YcombinatorsvgIconProps) {
...
export default YcombinatorsvgIcon;
/* prettier-ignore-end */
