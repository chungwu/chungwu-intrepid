...
import * as sty from "./PlasmicPrivacy.module.css"; // plasmic-import: 7xFwCyeLdghyeA/css
...
function PlasmicPrivacy__RenderFunc(props: {
  ...
  return (
    <React.Fragment>
      <Head>
        <title key="title">{"Privacy Policy | Intrepid Market"}</title>
        <meta
          key="og:title"
          property="og:title"
...
const PlasmicDescendants = {
  root: ["root", "navbarStatic", "privacyPolicyBody", "footerB"],
...
export const PlasmicPrivacy = Object.assign(
  ...
  makeNodeComponent("root"),
  {
    ...
    privacyPolicyBody: makeNodeComponent("privacyPolicyBody"),
